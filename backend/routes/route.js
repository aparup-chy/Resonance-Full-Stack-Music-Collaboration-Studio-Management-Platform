...
import * as siteInfoController from '../controllers/siteInfo.js';
...
// Like/Dislike routes for posts
router.post('/collaboration/posts/:postId/like', auth, (req, res) => {
  collaborationController.likePost(req, res);
});

router.post('/collaboration/posts/:postId/dislike', auth, (req, res) => {
  collaborationController.dislikePost(req, res);
});

// Like/Dislike routes for comments
router.post('/collaboration/comments/:commentId/like', auth, (req, res) => {
  collaborationController.likeComment(req, res);
});

router.post('/collaboration/comments/:commentId/dislike', auth, (req, res) => {
  collaborationController.dislikeComment(req, res);
});

// Reply routes
router.post('/collaboration/comments/:commentId/replies', auth, (req, res) => {
  collaborationController.addReply(req, res);
});

router.post('/collaboration/comments/:commentId/replies/:replyId/like', auth, (req, res) => {
  collaborationController.likeReply(req, res);
});

router.post('/collaboration/comments/:commentId/replies/:replyId/dislike', auth, (req, res) => {
  collaborationController.dislikeReply(req, res);
});

router.delete('/collaboration/comments/:commentId/replies/:replyId', auth, (req, res) => {
  collaborationController.deleteReply(req, res);
});
...
router.put('/notifications/mark-all/read', auth, (req, res) => {
