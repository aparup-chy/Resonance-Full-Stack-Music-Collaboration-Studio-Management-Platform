...
const ProductDetail = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-cover bg-center text-white" style={{ backgroundImage: "url('/piano-background.jpg')" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              {product.images && product.images.length > 0 ? (
                <div>
                  <div 
                    className="rounded-lg overflow-hidden h-80 mb-4 cursor-pointer hover:opacity-80 transition-opacity"
      ...
      {/* Image Gallery Modal */}
      {showGalleryModal && product.images && product.images.length > 0 && (
        <ImageGalleryModal
