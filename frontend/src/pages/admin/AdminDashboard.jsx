...
import { FaUsers, FaClipboardList, FaMusic, FaShoppingBag, FaCalendarAlt, FaGift, FaGuitar, FaComments } from 'react-icons/fa';
        ...
        <div className="container mx-auto">
          ...
          <div className="bg-black/70 backdrop-blur-md p-6 rounded-2xl shadow-2xl border border-white/30 text-white">
            <div className="flex mb-6 border-b border-white/20 overflow-x-auto">
              ...
              <button 
                className={`flex items-center px-4 py-3 text-base transition-colors hover:bg-white/10 ${
                  activeTab === 'collaboration' ? 'border-b-2 border-purple-400 font-medium text-purple-400' : 'text-white'
                }`}
                onClick={() => setActiveTab('collaboration')}
              >
                <span className="mr-2 flex items-center"><FaComments /></span>
